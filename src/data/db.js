...
export const projects = [
  ...
  },
  {
    ...
    img: wordle,
    title: "Wordle Clone",
    desc: "Wordle Clone - A fully responsive Wordle game built with Next.js 16, React 19, TypeScript 5, and Tailwind CSS 4. Players guess 5-letter words in 6 tries with real-time green/yellow/gray tile feedback. Features dynamic words from @faker-js/faker, mobile-first responsive design, smooth keyboard navigation, auto-focus row advancement, and production-grade error handling with 1000+ word offline fallback.",
    gitLink: "https://github.com/Joyram49/wordle-game-for-fun",
    gitLogo: TbLink,
    gitContent: "View on GitHub",
    webLink: "https://wordle-game-for-fun.netlify.app/",
    webLogo: FiExternalLink,
    webContent: "Explore Now",
  },
  {
